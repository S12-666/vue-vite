...
<template>
    <div class="user-header">
        ...
        <el-form :inline="true" :model="fromInline">
            ...
            <el-form-item>
                <el-button type="primary" @click="hindleSearch">搜索</el-button>
            </el-form-item>
        </el-form>
    </div>
    <div class="table">
        ...
        <el-pagination class="pager" background layout="prev, pager, next" :total="config.total" @current-change="handleChange"/>
    </div>
</template>
